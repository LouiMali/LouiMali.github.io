...
(() => {
  ...
  const translations = {
    de: {
      ...
      'tl-wiss-desc': 'Quereinsteiger in der 4-j\u00e4hrigen Ausbildung zur Informatikfachkraft mit Fokus auf Softwareentwicklung.',
      'tl-self-title': 'Selbststudium',
      'tl-self-desc': 'Vertiefung in Python und Webentwicklung durch Online-Kurse und eigenst\u00e4ndige Programmierprojekte.',
      'tl-projects-title': 'Eigenprojekte',
      'tl-projects-desc': 'Entwicklung von SkillTracker (JavaScript Web-App), Asteroids (Python/Pygame) und BookBot (Python Textanalyse).',
    ...
    en: {
      ...
      'tl-wiss-desc': 'Career changer in a 4-year vocational training programme for software development.',
      'tl-self-title': 'Self-directed Learning',
      'tl-self-desc': 'Deepening knowledge in Python and web development through online courses and independent coding projects.',
      'tl-projects-title': 'Personal Projects',
      'tl-projects-desc': 'Built SkillTracker (JavaScript web app), Asteroids (Python/Pygame) and BookBot (Python text analysis).',
      'tl-goal-date': 'Aug 2026',
